...
def load_kamus(filepath):
    ...
    if not os.path.exists(filepath):
        print(f"File {filepath} tidak ditemukan. Harap jalankan script word2vec.py (build) terlebih dahulu.")
        return None, None
...
def main():
    print("\n===================================")
    print("MEMUAT MODEL WORD2VEC SKIP-GRAM")
    print("===================================")
    
    # Memuat file dari folder saat ini (tempat word2vec.py aslinya berada)
